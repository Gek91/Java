...
//		}
		...
		urlList.add("https://www.nonconimieisoldi.org/feed");
		urlList.add("https://www.eticasgr.it/feed");
		urlList.add("https://sociinrete.bancaetica.it/offerte/feed");
		urlList.add("https://www.fcre.it/notizie?format=feed&type=rss");
		urlList.add("https://feeds.feedburner.com/fiarebancaetica/EkZs?fmt=xml");
		urlList.add("https://feeds.feedburner.com/bancaetica/blog?fmt=xml");
