package main.java.trying.lambda;
...
//		montecarloParallelDiceRoll();
	...
	private static void functionalInterfaceExample() {
		...
		//lambda with one argument (get a value, no return)
		...
		//Get two parameter of the same tipe and return a result of the same time
...
//			.min(Comparator.comparing(x -> x)) //custom comparator
			.get();	//optional is a value that may not exist
